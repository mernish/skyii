    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'viewPath' => 'Specify the directory for storing the view scripts for the controller. You may use path alias here, e.g.,
                <code>/var/www/basic/controllers/views/post</code>, <code>@backend/views/post</code>. If not set, it will default
                to <code>@backend/views/ControllerID</code>',
            'baseControllerClass' => 'This is the class that the new CRUD controller class will extend from.
                You should provide a fully qualified class name, e.g., <code>yii\web\Controller</code>.',
            'indexWidgetType' => 'This is the widget type to be used in the index page to display list of the models.
                You may choose either <code>GridView</code> or <code>ListView</code>',
            'searchModelClass' => 'This is the name of the search model class to be generated. You should provide a fully
                qualified namespaced class name, e.g., <code>backend\models\PostSearch</code>.',
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->phpType === 'boolean') {
            ...
            if (preg_match('/^(password|pass|passwd|passcode)$/i', $column->name)) {
                ...
                // Detect the date fields and convert them into datepicker
